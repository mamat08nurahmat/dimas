...
class siswa {
    ...
    function view() {
        ...
        $sql = "SELECT * FROM db_siswa ORDER BY nis DESC";
    ...
    function insert($nis, $nama, $tempat_lahir, $tanggal_lahir, $jenis_kelamin, $agama, $alamat, $no_telepon) {
        ...
        $sql = "INSERT INTO db_siswa (nis,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,agama,alamat,no_telepon) 
    ...
    function get_siswa($nis) {
        ...
        $sql = "SELECT * FROM db_siswa WHERE nis='$nis'";
    ...
    function update($nama, $tempat_lahir, $tanggal_lahir, $jenis_kelamin, $agama, $alamat, $no_telepon, $nis) {
        ...
        $sql = "UPDATE db_siswa SET nama            = '$nama',
    ...
    function delete($nis) {
        ...
        $sql = "DELETE FROM db_siswa WHERE nis = '$nis'";
