...
<?= form_open('', [
    'name'    => 'form_form_kode_grab', 
    'class'   => 'form-horizontal form_form_kode_grab', 
    'id'      => 'form_form_kode_grab',
...
<!-- <div class="form-group ">
    ...
    <div class="col-sm-6">
        <div class="col-md-2 padding-left-0">
            <label>
                <input type="radio" class="flat-red" name="is_used" id="is_used"  value="1" >
                Yes
            </label>
        </div>
        <div class="col-md-14">
            <label>
                <input type="radio" class="flat-red" name="is_used" id="is_used"  value="0">
                No
            </label>
        </div>
        <small class="info help-block">
...
<div class="form-group ">
    ...
    <div class="col-sm-6">
    <div class="input-group date col-sm-8">
      <input type="text" class="form-control pull-right datepicker" name="used_at"  placeholder="" id="used_at" >
    </div>
    <small class="info help-block">
    </small>
    </div>
    ...
    $(document).ready(function(){
     ...
     $('input[type="checkbox"].flat-red').iCheck({
      ...
      $('.btn_save').click(function(){
        ...
        var form_form_kode_grab = $('#form_form_kode_grab');
        var data_post = form_form_kode_grab.serializeArray();
        var save_type = $(this).attr('data-stype');
    
        $('.loading').show();
    
        $.ajax({
          url: BASE_URL + 'form/form_kode_grab/submit',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
