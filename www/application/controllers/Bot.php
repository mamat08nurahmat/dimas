...
class Bot extends Front
{
    ...
    public function webhook(){
        ...
        $webhookUrl = "http://" . $_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/webhook.php';                              
        $data = array('webhookUrl'=>$webhookUrl);
        $this->sendRequest('webhook',$data);
        print_r('webhook running on '.$webhookUrl);        
    }
...
endforeach;
        ...
        $sql2 = "
        SELECT count(*) as jumlah_data ,update_at from grab_report group by update_at
        "; 
