...
class Model_system_upload extends MY_Model {
	...
	private $field_search 	= ['file_name', 'application_source', 'batch_id', 'process_month', 'process_year', 'uploader', 'upload_at', 'update_at'];
    ...
    public function filter_avaiable() {
        $this->db->where('uploader', get_user_data('id'));
