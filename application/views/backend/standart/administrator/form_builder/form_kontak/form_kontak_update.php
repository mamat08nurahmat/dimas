                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/form_kontak/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="kelompok" id="kelompok" data-placeholder="Select Kelompok" >
                                    <option value=""></option>
                                    <option <?= $form_kontak->kelompok == "SPO" ? 'selected' :''; ?> value="SPO">SPO</option>
                                    <option <?= $form_kontak->kelompok == "SMN" ? 'selected' :''; ?> value="SMN">SMN</option>
                                    <option <?= $form_kontak->kelompok == "SGV" ? 'selected' :''; ?> value="SGV">SGV</option>
                                    <option <?= $form_kontak->kelompok == "TES" ? 'selected' :''; ?> value="TES">TES</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
