  ...
  <div class="row">
    <div class="col-md-6">
      <?php if($this->input->post('_stardate')==False){
                echo '<h3> Report Kode Terpakai</h3>';
          }else{?>
              <h3> Report Kode Terpakai</h3> 
      ...
      <div class="box box-warning">
        <div class="box-body">
          <div class="box box-widget widget-user-2">
                  <!-- ------------------------------------------------------------------ -->
                <?= form_open(base_url('administrator/Form_report_kode_grab/sortterpakai'), [
                  ...
                  <div class="col-md-6" style="padding-top:20px;margin-left:-25px">
                    ...
                    if($this->input->post('_stardate')==NULL){
                      ...
                      <a href="<?= base_url('administrator/form_report_kode_grab/terpakai')?>"class="btn btn-success"><i class="fa fa-refresh"></i></a>
                    <?php }?>
                  </div>
                  <!-- ------------------------------------------------------------------ -->
                  <!-- ------------------------------------------------------------------ -->
            ...
            <table id="myTable"class="table table-striped table-hover table-striped table-sm table-bordered">
              ...
              <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td><?= $dt['kode_grab']?></td>
                    <td><?= $dt['order_voucher_at']; ?></td>
                    <td>
                        <a href="<?= base_url('administrator/Form_report_kode_grab/detailtpk/').$dt['kode_grab']?>" ><i class="fa fa-search"></i><button class="badge badge-dark" title="Detail" ></button></a>
                    </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
...
//   <script>
// var ctx = document.getElementById("msyChart").getContext('2d');
// var myChart = new Chart(ctx, {
//     type: 'line',
//     data: {
