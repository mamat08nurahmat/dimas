<section class="content-header">
  <div class="row">
    <div class="col-md-6">
      <h3> Grafik Pemakaian Kode Grab Tahun <?= date('Y')?></h3> 
    </div> 
    <div class="col-md-3">
    ...
    <div class="col-md-3">
			<div class="box box-warning">
				<div class="box-body">
					...
					<div class="row">
						<div class="col-md-12">
							<a href="#" class="btn btn-info btn-block">Export</a>
						</div>
					</div>
        </div>
      </div>
...
<?php for($a=1;$a<=12;$a++){$b[]=json_encode($a);}?>
...
<script>
		...
		var myChart = new Chart(ctx, {
			type: 'bar',
			data: {
				labels: ['Januari','Februari','Maret','April','Mei','Juni','Julil','Agustus','September','Oktober','November','Desember'],
				datasets: [{
